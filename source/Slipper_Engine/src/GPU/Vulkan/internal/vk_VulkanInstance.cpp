...
namespace Slipper::GPU::Vulkan
{
    VulkanInstance::VulkanInstance()
    {
        ...
        constexpr vk::ApplicationInfo app_info(
            "Slipper", VK_MAKE_VERSION(1, 0, 0), "SlipperEngine", VK_MAKE_VERSION(1, 0, 0), VK_API_VERSION_1_3);
        ...
        if (Vulkan::EnableValidationLayers)
        {
            ...
            ASSERT(Vulkan::EnableValidationLayers &&
                       CheckValidationLayerSupport(Vulkan::VALIDATION_LAYERS, instance_layer_properties),
                   "Validation layers requested, but not available!")
            validation_layers = Vulkan::VALIDATION_LAYERS;

            validation_features.setEnabledValidationFeatures(Vulkan::PRINTF_ENABLES);
        }

        // Extensions
        auto extensions = GetRequiredExtensions();
        extensions.insert(extensions.end(), Vulkan::INSTANCE_EXTENSIONS.begin(), Vulkan::INSTANCE_EXTENSIONS.end());
        ...
        VK_HPP_ASSERT(vk::createInstance(&create_info, nullptr, &instance), "Failed to create VkInstance!")
    ...
    bool VulkanInstance::CheckValidationLayerSupport(std::vector<char const *> const &Layers,
